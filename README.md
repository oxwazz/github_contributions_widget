...
> or you can update `?refresh-cache=` automatically using GitHub Action
> using [probablykasper/readme-template-action](https://github.com/probablykasper/readme-template-action),
